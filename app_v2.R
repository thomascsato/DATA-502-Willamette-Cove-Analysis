...
##########################
ui <- fluidPage(
  titlePanel("Chemicals of Concern Concentration Plot"),
  
  fluidRow(
    column(
      width = 8,  
      div(style = "padding-top: 5px;", 
          HTML("<b>Note:</b> Click on a DU to display the screening levels. Select the small map view to compare sample depths.")
      )
    )
  ),
  ...
  fluidRow(
    ...
    column(
      width = 2,  # Adjust width to fit the layout
